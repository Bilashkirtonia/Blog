...
if($_SERVER['REQUEST_METHOD'] == 'POST'){
    ...
    if($title == '' ||$slogan == '' ||$new_name == ''){
        ...
        if(in_array($file_ex,$extension)===false){
            ...
            $query = "INSERT INTO  logo(title,logo,slogan)
            VALUES('$title','$new_name','$slogan')";
            ...
            <div class="card-body px-lg-5">
                ...
                <form class="text-center" style="color: #757575;" action="" method="post" enctype="multipart/form-data">
                    ...
                    <div class="md-form mt-3">
                        <input  type="text" name="title" id="materialSubscriptionFormPasswords"  placeholder="Enter title" class="form-control">
                    </div>
                    <div class="md-form mt-3">
                        <input  type="file" name="file" id="materialSubscriptionFormPasswords"  placeholder="Enter logo" class="form-control">
                    </div>
                    <div class="md-form mt-3">
                        <input  type="text" name="slogan" id="materialSubscriptionFormPasswords"  placeholder="Enter slogan" class="form-control">
                    </div>
