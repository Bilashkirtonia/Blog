        ...
        <div id="table" class="table-editable">
          ...
          <?php 
                if(isset($_REQUEST['deleid'])){
                  $did = $_GET['deleid'];
                  $query = "SELECT * FROM logo WHERE id = $did ";
                  ...
                  $query = "DELETE FROM logo WHERE id = $did ";
          ...
          <table class="table table-bordered table-responsive-md table-striped text-center">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td class="pt-3-half" contenteditable="true"><img width="60" src="../image/<?php echo $value['logo'];?>" alt=""></td>
                <td class="pt-3-half" contenteditable="true"><?php echo $value['slogan'];?></td>
                ...
                <td>
                  <span class="table-remove"
                    ><a href="slogan.php?eid=<?php echo $value['id'];?>">
